...
- [**Storybook 9**](https://storybook.js.org/blog/storybook-9/), with huge improvements in bundle size and installed dependencies, along with better testing tools. They offer a migration tool that worked flawlessly for [RIS UI.](https://github.com/digitalservicebund/ris-ui/pull/245) Here's an [interview](https://www.youtube.com/watch?v=-QRzlQbUHcc) with one of the engineers if you want to hear more.
...
- [**JSPM 4**](https://jspm.org/jspm-4.0-release), a different take on package management for the frontend that builds on web standards. I haven't tried it yet, but I'm intrigued.
