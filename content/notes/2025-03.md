...
- **Corepack will be removed from Node:** if you know what Corepack is, [this](https://socket.dev/blog/node-js-tsc-votes-to-stop-distributing-corepack) is good to know. If the word Corepack doesn't mean anything to you, there's no reason to find out anymore 😄
